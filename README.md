...
repositories |                          简介                          |开发语言|
 :------------ |:----------------------------------------------------:|:---:|
|[`alibaba/page-agent` ![](https://img.shields.io/github/stars/alibaba/page-agent.svg?style=social&languages=Star)](https://github.com/alibaba/page-agent)|纯 JS 实现的 GUI agent。使用自然语言操作你的 Web 应用。无须后端、客户端、浏览器插件|TypeScript|
...
repositories |                          简介                          |开发语言|
 :------------ |:----------------------------------------------------:|:---:|
|[`vbgate/learn-opencode` ![](https://img.shields.io/github/stars/vbgate/learn-opencode.svg?style=social&languages=Star)](https://github.com/vbgate/learn-opencode)|OpenCode 中文实战课源码与内容仓库：一课一页，覆盖入门到实战工作流|Shell|
...
repositories |                          简介                          |开发语言|
 :------------ |:----------------------------------------------------:|:---:|
|[`mattpocock/skills` ![](https://img.shields.io/github/stars/mattpocock/skills.svg?style=social&languages=Star)](https://github.com/mattpocock/skills)|Matt Pocock的Agent Skills|~|
...
[`alibaba/otter` ![](https://img.shields.io/github/stars/alibaba/otter.svg?style=social&label=Star)](https://github.com/alibaba/otter)|                         基于数据库增量日志解析准实时同步到本机房或异地机房的mysql/oracle数据库一个分布式数据库同步系统                          |
...
repositories | 简介  |开发语言|
 :------------ |:---:|:---:|
|[`link1st/go-stress-testing` ![](https://img.shields.io/github/stars/link1st/go-stress-testing.svg?style=social&languages=Star)](https://github.com/link1st/go-stress-testing)|go 实现的压测工具|Go|
